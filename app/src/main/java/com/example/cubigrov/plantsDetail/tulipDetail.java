...
public class tulipDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tulip_details);
        ...
        stitchAppClient.getAuth().loginWithCredential(new AnonymousCredential()).addOnSuccessListener(new OnSuccessListener<StitchUser>() {
            ...
            public void onSuccess(final StitchUser stitchUser) {
                ...
                final RemoteFindIterable<Document> query = myCollection.find(Filters.eq("plant_name", "Tulip"));
                ...
                query.into(result).addOnSuccessListener(new OnSuccessListener<ArrayList>() {
                    ...
                    public void onSuccess(ArrayList arrayList) {
                        ...
                        TextView text = (TextView)findViewById(R.id.tulip_textview);
        ...
        mBackImageView = findViewById(R.id.tulip_back);
